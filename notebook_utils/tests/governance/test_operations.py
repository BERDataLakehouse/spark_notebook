"""
Tests for governance/operations.py module.
"""
...
class TestCheckGovernanceHealth:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.health_check_health_get")
...
class TestGetCredentials:
    """Tests for get_credentials function (unified S3 + Polaris bundle)."""

    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.os")
    @patch("berdl_notebook_utils.governance.operations.get_credentials_credentials_get")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    def test_fetches_credentials_from_api(self, mock_get_client, mock_get_creds, mock_os, mock_get_settings):
        """Test fetches credentials from API and sets BOTH S3 + Polaris env vars."""
        mock_client = Mock()
        mock_get_client.return_value = mock_client

        mock_creds = Mock(spec=CredentialsResponse)
        mock_creds.s3_access_key = "new_key"
        mock_creds.s3_secret_key = "new_secret"
        mock_creds.polaris_client_id = "polaris_id"
        mock_creds.polaris_client_secret = "polaris_secret"
        ...
        # S3 IAM half
        mock_os.environ.__setitem__.assert_any_call("S3_ACCESS_KEY", "new_key")
        mock_os.environ.__setitem__.assert_any_call("S3_SECRET_KEY", "new_secret")
        # Polaris OAuth half — populated from the same response, no second API call
        mock_os.environ.__setitem__.assert_any_call("POLARIS_CREDENTIAL", "polaris_id:polaris_secret")
...
class TestRotateCredentials:
    """Tests for rotate_credentials function (rotates both S3 + Polaris)."""

    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.os")
    @patch("berdl_notebook_utils.governance.operations.rotate_credentials_credentials_rotate_post")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    def test_rotates_and_updates_env_vars(self, mock_get_client, mock_rotate_api, mock_os, mock_get_settings):
        """Test rotate calls API and updates BOTH S3 + Polaris env vars."""
        mock_client = Mock()
        mock_get_client.return_value = mock_client

        mock_creds = Mock(spec=CredentialsResponse)
        mock_creds.s3_access_key = "rotated_key"
        mock_creds.s3_secret_key = "rotated_secret"
        mock_creds.polaris_client_id = "rotated_polaris_id"
        mock_creds.polaris_client_secret = "rotated_polaris_secret"
        ...
        mock_os.environ.__setitem__.assert_any_call("S3_ACCESS_KEY", "rotated_key")
        mock_os.environ.__setitem__.assert_any_call("S3_SECRET_KEY", "rotated_secret")
        # Polaris half rotated alongside.
        mock_os.environ.__setitem__.assert_any_call("POLARIS_CREDENTIAL", "rotated_polaris_id:rotated_polaris_secret")
        mock_get_settings.cache_clear.assert_called_once()
...
class TestGetMySqlWarehouse:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch(
        "berdl_notebook_utils.governance.operations.get_my_sql_warehouse_prefix_workspaces_me_sql_warehouse_prefix_get"
    )
...
class TestGetGroupSqlWarehouse:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch(
        "berdl_notebook_utils.governance.operations.get_group_sql_warehouse_prefix_workspaces_me_groups_group_name_sql_warehouse_prefix_get"
    )
...
class TestGetNamespacePrefix:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_namespace_prefix_workspaces_me_namespace_prefix_get")
...
class TestGetMyWorkspace:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_my_workspace_workspaces_me_get")
...
class TestGetMyPolicies:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_my_policies_workspaces_me_policies_get")
...
class TestGetMyGroups:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_my_groups_workspaces_me_groups_get")
...
class TestGetMyAccessiblePaths:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_my_accessible_paths_workspaces_me_accessible_paths_get")
...
class TestGetTableAccessInfo:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_path_access_info_sharing_get_path_access_info_post")
...
class TestShareTable:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.share_data_sharing_share_post")
...
class TestUnshareTable:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.unshare_data_sharing_unshare_post")
...
class TestMakeTablePublic:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.make_path_public_sharing_make_public_post")
...
class TestMakeTablePrivate:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.make_path_private_sharing_make_private_post")
...
class TestListAvailableGroups:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.list_group_names_sync")
...
class TestListGroups:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.list_groups_management_groups_get")
...
class TestListUsers:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.list_users_management_users_get")
...
class TestAddGroupMember:
    ...
    @patch("berdl_notebook_utils.governance.operations.time")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch(
        "berdl_notebook_utils.governance.operations.add_group_member_management_groups_group_name_members_username_post"
    )
...
class TestRemoveGroupMember:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch(
        "berdl_notebook_utils.governance.operations.remove_group_member_management_groups_group_name_members_username_delete"
    )
...
class TestCreateTenantAndAssignUsers:
    ...
    @patch("berdl_notebook_utils.governance.operations.time")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.create_group_management_groups_group_name_post")
    @patch(
        "berdl_notebook_utils.governance.operations.add_group_member_management_groups_group_name_members_username_post"
    )
...
class TestRequestTenantAccess:
    ...
    @patch("berdl_notebook_utils.governance.operations.httpx")
    @patch("berdl_notebook_utils.governance.operations.get_settings")
...
class TestListUserNames:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.list_user_names_sync")
...
class TestRegeneratePolicies:
    ...
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch(
        "berdl_notebook_utils.governance.operations.regenerate_all_policies_management_migrate_regenerate_policies_post"
    )
...
class TestGetPolarisCatalogInfo:
    """Tests for get_polaris_catalog_info — read-only catalog metadata via /polaris/effective-access/me.

    Distinct from provision_polaris_user (which uses POST
    /polaris/user_provision/{u} and ALSO returns credentials).
    get_polaris_catalog_info is the lighter-weight, side-effect-free
    discovery primitive — it doesn't touch credentials and doesn't
    trigger any provisioning on the server.
    """

    @patch("berdl_notebook_utils.governance.operations.get_settings")
    def test_returns_none_when_polaris_not_configured(self, mock_settings):
        """Test returns None when POLARIS_CATALOG_URI is not set."""

        mock_settings.return_value.POLARIS_CATALOG_URI = None
        assert get_polaris_catalog_info() is None

    @patch("berdl_notebook_utils.governance.operations.os")
    @patch("berdl_notebook_utils.governance.operations.get_my_effective_access_polaris_effective_access_me_get")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    def test_fetches_catalog_metadata_and_sets_env(
        self, mock_settings, mock_get_client, mock_effective_access, mock_os
    ):
        """Returns personal + tenant catalog names and populates POLARIS_* catalog env vars only.

        Asserts that POLARIS_CREDENTIAL is NOT touched here — credentials
        are owned by get_credentials/rotate_credentials.
        """
        mock_settings.return_value.POLARIS_CATALOG_URI = "http://polaris:8181/api/catalog"

        tenant_a = Mock()
        tenant_a.catalog_name = "tenant_team_a"
        tenant_b = Mock()
        tenant_b.catalog_name = "tenant_team_b"
        api_response = Mock(spec=PolarisEffectiveAccessResponse)
        api_response.personal_catalog = "user_alice"
        api_response.group_tenants = [tenant_a, tenant_b]
        mock_effective_access.sync.return_value = api_response

        result = get_polaris_catalog_info()

        assert result == {
            "personal_catalog": "user_alice",
            "tenant_catalogs": ["tenant_team_a", "tenant_team_b"],
        }
        mock_os.environ.__setitem__.assert_any_call("POLARIS_PERSONAL_CATALOG", "user_alice")
        mock_os.environ.__setitem__.assert_any_call("POLARIS_TENANT_CATALOGS", "tenant_team_a,tenant_team_b")
        # Crucially, POLARIS_CREDENTIAL is owned by get_credentials/rotate_credentials.
        for call in mock_os.environ.__setitem__.call_args_list:
            assert call.args[0] != "POLARIS_CREDENTIAL", (
                "get_polaris_catalog_info must NOT touch POLARIS_CREDENTIAL — "
                "that's get_credentials/rotate_credentials' responsibility"
            )

    @patch("berdl_notebook_utils.governance.operations.get_my_effective_access_polaris_effective_access_me_get")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_settings")
    def test_returns_none_on_error_response(self, mock_settings, mock_get_client, mock_effective_access):
        """Test returns None when API returns ErrorResponse."""

        mock_settings.return_value.POLARIS_CATALOG_URI = "http://polaris:8181/api/catalog"
        mock_error = Mock(spec=ErrorResponse)
        mock_error.message = "forbidden"
        mock_effective_access.sync.return_value = mock_error
        assert get_polaris_catalog_info() is None


class TestProvisionPolarisUser:
    """Tests for provision_polaris_user function."""
    ...
    def test_returns_none_when_polaris_not_configured(self, mock_settings, mock_os):
        ...
        result = provision_polaris_user()

        assert result is None

    @patch("berdl_notebook_utils.governance.operations.os")
    @patch("berdl_notebook_utils.governance.operations.provision_polaris_user_polaris_user_provision_username_post")
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_settings")
...
class TestRotatePolarisCredentials:
    ...
    @patch("berdl_notebook_utils.governance.operations.os")
    @patch(
        "berdl_notebook_utils.governance.operations.rotate_polaris_credentials_polaris_credentials_rotate_username_post"
    )
    @patch("berdl_notebook_utils.governance.operations.get_governance_client")
    @patch("berdl_notebook_utils.governance.operations.get_settings")
...
class TestNamespaceAccess:
    ...
    @patch("berdl_notebook_utils.governance.operations.httpx.request")
    @patch("berdl_notebook_utils.governance.operations.get_settings")
