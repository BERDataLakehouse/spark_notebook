"""
Pydantic models for BERDL MinIO Data Governance API responses

These models define the request/response structure for interacting with the
BERDL Data Governance API service.
"""
