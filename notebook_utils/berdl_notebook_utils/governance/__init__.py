"""
BERDL Data Governance integration for notebooks.

This package provides integration with the BERDL Data Governance API
(MMS) for managing S3 / MinIO storage permissions, Polaris Iceberg
catalogs, user workspaces, and data sharing in notebook environments.
"""
...
__all__ = [
    # Workspace/user info + credentials
    "check_governance_health",
    "get_credentials",
    "get_group_sql_warehouse",
    "get_my_accessible_paths",
